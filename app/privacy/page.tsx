...
export default function PrivacyPage(){return <main className="document shell">
  ...
  <article className="prose">
    ...
    <h2>Information processed automatically</h2><ul><li>Product interactions such as onboarding progress, paywall views, alarm creation, and mission completion, used to understand reliability and improve Bemi.</li><li>Subscription status and purchase lifecycle information from Apple through RevenueCat, including trials, renewals, cancellations, and refunds.</li><li>Install and campaign attribution from Apple AdServices and AppsFlyer. Availability and detail depend on your device privacy settings and Apple policies.</li><li>Basic device and diagnostic information supplied by our service providers when needed to operate, secure, and improve the app.</li></ul>
    ...
    <h2>Service providers</h2><p>Bemi uses Apple, Supabase, RevenueCat, PostHog, and AppsFlyer. These providers process information under their own security and privacy commitments for the services configured by Bemi.</p>

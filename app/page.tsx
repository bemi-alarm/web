...
export default function Home() {
  return (
    <main>
      ...
      <section className="final-cta shell"><div className="cta-copy"><p className="eyebrow">TOMORROW STARTS TONIGHT</p><h2>Make your first decision of the day an easy one.</h2><p>Set one alarm. Choose one mission. Let Bemi handle the handoff to morning.</p><a className="button button-dark" href="#how-it-works">Explore Bemi <span aria-hidden="true">↑</span></a></div><div className="cta-mascot"><img src="/bemi-icon.png" alt="Bemi, your morning companion" width="420" height="420" /></div></section>
